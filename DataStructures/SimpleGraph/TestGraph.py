...
class TestBST(unittest.TestCase):
    ...
    def test_DepthFirstSearc2(self):
        ...
        self.assertEqual(len(graph.BreadthFirstSearch(0, 6)), 4)
        self.assertEqual(graph.BreadthFirstSearch(0, 6)[0].Value, 0)
        self.assertEqual(graph.BreadthFirstSearch(0, 6)[1].Value, 1)
        self.assertEqual(graph.BreadthFirstSearch(0, 6)[2].Value, 2)
        self.assertEqual(graph.BreadthFirstSearch(0, 6)[3].Value, 6)

        self.assertEqual(graph.BreadthFirstSearch(0, 2)[0].Value, 0)
        self.assertEqual(graph.BreadthFirstSearch(0, 2)[1].Value, 1)
        self.assertEqual(graph.BreadthFirstSearch(0, 2)[2].Value, 2)

        #self.assertEqual(len(graph.BreadthFirstSearch(3, 7)), 5)
        self.assertEqual(graph.BreadthFirstSearch(3, 7)[0].Value, 3)
